    ...
    <section className="mx-auto flex min-h-[500px] w-full max-w-[800px] items-center justify-center rounded-[40px] bg-white px-8 py-10 shadow-xl border border-slate-200">
      <div className="w-full max-w-[500px]">
        ...
        {success ? (
          ...
          <form className="space-y-6" onSubmit={step === 1 ? handleSendOTP : handleReset}>
            ...
            {step === 2 && (
              <>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700" htmlFor="reset-otp">
                    OTP (Use 123456)
                  </label>
                  <input
                    id="reset-otp"
            ...
            <p className="mt-8 text-center text-[15px] text-slate-600">
              Remember your password? <Link href="/login" className="font-semibold text-[#e65a28] hover:underline">Sign in</Link>
            </p>
          </form>
        )}
      </div>

        ...
        <div className="mx-auto w-full max-w-[380px] relative z-10">
          ...
          {mode === 'password' && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <form className="mt-8 space-y-5" onSubmit={handlePasswordLogin}>
                <div>
                  <label className="mb-2 block text-sm font-medium text-slate-700">Account Name or Email</label>
                  <input 
                ...
                <div className="flex items-center justify-between mt-4">
                  <label className="flex items-center gap-2 cursor-pointer text-sm text-slate-600">
                    <input type="checkbox" className="size-4 rounded border-slate-300 text-[#e65a28] focus:ring-[#e65a28]" />
                    Remember device
                  </label>
                  <Link href="/reset-password" className="text-sm font-semibold text-[#e65a28] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                ...
                <div className="relative mt-8 flex items-center justify-center">
                  ...
                  <span className="relative bg-white px-4 text-xs text-slate-400 uppercase tracking-wider">or continue with</span>
                </div>
                
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <button type="button" onClick={() => { setMode('google_email'); setError(''); }} className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm">
                  ...
                  <button type="button" className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm cursor-not-allowed opacity-50">
                ...
                <p className="mt-10 text-center text-[15px] text-slate-600">
                  Don't have an account? <Link href="/sign-up" className="font-semibold text-[#e65a28] hover:underline">Sign up</Link>
                </p>
              </form>
            </div>
          )}
          ...
          {mode === 'google_email' && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              >
                <svg className="mr-2 size-4" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              <h2 className="text-3xl font-bold text-center text-slate-900">Sign in with Google</h2>
              ...
              <form className="mt-8 space-y-5" onSubmit={handleGoogleEmailSubmit}>
                <div>
                  <input 
                    type="email"
                    value={googleEmail} 
              ...
              <div className="flex justify-center mb-6">
                <div className="rounded-full bg-slate-50 p-4 border border-slate-100 shadow-inner flex flex-col items-center justify-center">
                  <div className="flex items-center gap-2 border border-slate-200 rounded-full py-1 px-3 bg-white">
                    ...
                    <span className="text-xs font-semibold text-slate-700">{googleEmail}</span>
                  </div>
                </div>
              </div>

              <h2 className="text-3xl font-bold text-center text-slate-900">2-Step Verification</h2>
              <p className="mt-2 text-[15px] text-center text-slate-500">
                An email with a verification code was just sent to <strong className="text-slate-800">{googleEmail}</strong>. (Use 123456 for demo)
              </p>

                  ...
                  <div className="p-2 space-y-1">
                    <div className="p-3 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer">
                      ...
                      <p className="text-xs text-slate-500 mt-1">
                        Unrecognized device just logged in.
                      </p>
                    </div>
                  </div>
                  <div className="p-3 border-t border-slate-100 text-center">
                    <button className="text-xs font-semibold text-[#e65a28]">
                      Mark all as read
                    </button>
                  </div>
                </div>
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <button
                  ...
                  className="rounded-xl bg-[#e65a28] px-6 py-3 font-bold text-white shadow-md shadow-orange-500/20 transition-all hover:bg-[#d44d1e] hover:shadow-lg hover:shadow-orange-500/30"
                >
                  Transfer Money
                </button>
                <button
                  onClick={() => router.push('/pay-bills')}
                  className="rounded-xl border border-slate-200 bg-white px-6 py-3 font-bold text-slate-700 shadow-sm transition-all hover:bg-slate-50 hover:text-slate-900"
                >
                  Pay Bills
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="group flex flex-col items-center gap-3 rounded-2xl bg-slate-50 p-4 transition-all hover:bg-orange-50 hover:shadow-sm border border-transparent hover:border-orange-100"
                >
                  ...
                  <span className="text-sm font-semibold text-slate-700 group-hover:text-[#e65a28] transition-colors">
                    Accounts
                  </span>
                </button>
                <button
                  onClick={() => router.push('/smart-spend')}
                  className="group flex flex-col items-center gap-3 rounded-2xl bg-slate-50 p-4 transition-all hover:bg-orange-50 hover:shadow-sm border border-transparent hover:border-orange-100"
                >
                  <div className="flex size-12 items-center justify-center rounded-full bg-white text-slate-600 shadow-sm group-hover:text-[#e65a28] group-hover:scale-110 transition-all">
                    <svg
            ...
            <div className="lg:col-span-2 rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                ...
                <button className="text-sm font-semibold text-[#e65a28] hover:text-orange-600 transition-colors">
                  View All
                </button>
              </div>
                  ...
                  {stats.transactions.map((tx, idx) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p
                          className={`font-bold ${tx.amount < 0 ? 'text-slate-900' : 'text-green-600'}`}
                        >
                          {tx.amount < 0 ? '-' : '+'}Rs.{' '}

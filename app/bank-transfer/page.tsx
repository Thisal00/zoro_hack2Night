...
export default function BankTransferPage() {
  ...
  const [transferFrom, setTransferFrom] = useState('7788990011') // Mock main account number
              ...
              <form onSubmit={handleNext} className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    >
                      <option value="7788990011">Nova Main Account (****0011) - Rs. {balance.toLocaleString('en-US', { minimumFractionDigits: 2 })}</option>
                      <option value="5566778899">Nova Savings Account (****8899) - Rs. 15,000.00</option>
                    </select>
              ...
              <div className="bg-[#0f0f11] rounded-2xl p-6 border border-white/5 relative z-10 mb-8 max-w-lg mx-auto">
                ...
                <div className="space-y-4 border-t border-white/5 pt-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white font-mono">{transferFrom === '7788990011' ? 'Nova Main (****0011)' : 'Nova Savings (****8899)'}</span>
                  </div>
                  <div className="flex justify-between items-center">

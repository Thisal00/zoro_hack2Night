...
export default function SignUpPage() {
  ...
  const fields = [
    { label: 'Account Number', name: 'account_number', type: 'text', placeholder: '1002 4567 8901', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg> },
    { label: 'Account Identity', name: 'account_name', type: 'text', placeholder: 'admin', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
    { label: 'Branch', name: 'branch', type: 'text', placeholder: 'Main Branch', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
    { label: 'Email', name: 'email', type: 'email', placeholder: 'name@example.com', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> },
    { label: 'Security Key', name: 'password', type: 'password', placeholder: '••••••••', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> },
    { label: 'Confirm Security Key', name: 'confirm_password', type: 'password', placeholder: '••••••••', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg> }
  ];
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0a0a0a] p-4 sm:p-8 font-sans selection:bg-[#ff5a1f] selection:text-white">
      ...
      <div className="w-full max-w-[1100px] min-h-[700px] flex flex-col md:flex-row bg-[#111111] rounded-[24px] overflow-hidden shadow-2xl border border-white/5">
        ...
        {/* Right Form Pane */}
        <div className="w-full md:w-[55%] px-10 py-8 lg:px-14 flex flex-col relative max-h-[90vh] overflow-y-auto custom-scrollbar">
          
          <div className="mb-8">
            <h2 className="text-[28px] font-semibold text-white mb-2" style={{ color: '#ffffff' }}>Create an account</h2>
            <p className="text-[14px] text-gray-400">
              Register to access your new NovaBank terminal.
            </p>
          </div>
          ...
          <form className="space-y-4">
            {fields.map((field) => (
              <div key={field.name} className="space-y-2">
                <label className="text-[13px] font-medium text-white">{field.label}</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3.5 rounded-xl border border-white/10 bg-white/5 text-white text-[15px] focus:bg-white/10 focus:border-[#ff5a1f] focus:ring-1 focus:ring-[#ff5a1f] transition-all outline-none placeholder-gray-500 ${field.type === 'password' ? 'tracking-widest' : ''}`}
                    required
                  />
                  {field.type === 'password' && (
          ...
          <div className="mt-12 text-center pb-8">
            <p className="text-[14px] text-gray-500">
              Already have an account? <Link href="/login" className="font-semibold text-[#ff5a1f] hover:text-[#e64a15] transition-colors">Log in</Link>
            </p>
          </div>

          <div className="hidden md:flex mt-auto pt-6 items-center justify-center gap-2 text-gray-600 text-xs w-full">
